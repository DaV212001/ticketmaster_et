...
class ShimmerWrapper extends StatelessWidget {
  ...
  Widget _buildShimmerLayout(Widget widget, BuildContext context) {
    ...
    if (widget is Column || widget is Row) {
      ...
      return ListTile(
          leading: _buildShimmerLayout(widget.leading!, context),
          title: _buildShimmerLayout(widget.title!, context),
          subtitle: _buildShimmerLayout(widget.subtitle!, context),
          trailing: _buildShimmerLayout(widget.trailing!, context),
