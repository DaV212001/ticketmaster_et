...
class _ForgetPassword0State extends State<ForgetPassword0> {
  ...
  print("forgetPassword = ${phone1}  and  ${otp}");
    ...
    try {
      ...
      response = http.post(
          Uri.parse("https://api.ticketmaster-et.com/api/send-otp"),
          body: requestBody,
          headers: {
  ...
  String generateRandomNumber(){
    var random = Random();
    int temporaryNumber = random.nextInt(90000) + 10000; // Generate a random integer between 10000 and 99999
                      ...
                      children: [
                        ...
                        OutlinedButton(
                            ...
                            onPressed: () async {
                              ...
                              var response =
                              await forgetPassword(phoneController.text, number);
                              print("pressed 2");
                              print(response.body);
                              ...
                              if(data['message'] == 'OTP sent succesfully' || response.statusCode==201){
                                ...
                                Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                        builder: (context) =>
                                            ForgetPassword1(phone: phoneController.text)));
                              }else if(data['message'] == 'phone number is not found'){
                                setState(() {
                                  _isLoading = false;
                                });
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    content: Text(tr('phone_number_is_not_found')),
