...
class OrganizerReview extends StatefulWidget {
  ...
  OrganizerReview({super.key, required this.organizer});
  ...
  Future<void> getReviewByOrganizer(String id) async {
    ...
    try {
      var res = await retryOptions.retry(
        () => http.get(
            Uri.parse("${baseUrlFunc}review-by-organizer/${int.parse(id)}")),
        ...
        _isLoading
            ...
            : OutlinedButton(
                ...
                onPressed: () async {
                  ...
                  var response = await reviewByOrganizer(widget.organizer.id,
