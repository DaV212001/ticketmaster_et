...
class _EventReviewState extends State<EventReview> {
  ...
  Future<http.Response> reviewBySubCategory(int? eventId, String star, String comment) async {
    ...
    String sub_category_id= widget.event.id.toString();
  ...
  List<Review> reviews = [];
  Future<void> getReviewByEvent(String id) async {
    List<Review> review = [];

    print("getReviewByEvent");
    try {
      var res = await retryOptions.retry(
            () => http.get(Uri.parse("https://api.ticketmaster-et.com/api/review-by-event/${int.parse(id)}")),
        retryIf: (e) => e is SocketException || e is TimeoutException,
      );https://api.ticketmaster-et.com/api/review-by-event/6
  ...
  void initState() {
    ...
    print("Initstate");
    getReviewByEvent(widget.event.id!.toString());
    super.initState();
  }
  @override
