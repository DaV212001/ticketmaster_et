...
class Endpoints {
  ...
  //   return "$baseUrlFunc" "/category";
  // }
  //
  // static String popular({String id = "8"}) {
  //   return "$baseUrlFunc" "/popular";
  // }
  //
  // static String upcoming({int id = 3}) {
  //   return "$baseUrlFunc" "/upcoming";
  // }
  //
  // static String homecatandsubcat() {
  //   return "$baseUrlFunc" "/category-sub-category";
  // }
  //
  // static String eventbysubcat(String id) {
  //   return '$baseUrlFunc' "/event-by-sub-category/$id";
  // }
  //
  // static String organizers() {
  //   return '$baseUrlFunc' '/organizer';
  // }
